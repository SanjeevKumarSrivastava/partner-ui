...
export const registrationPartnerId = 'mosip.partnermanagement.partners.create';
export const registrationCenterCreateId = 'mosip.partnermanagement.partners.update';
...
export const ListViewIdKeyMapping = {
  centers: { idKey: 'partnerID', imagePath: 'assets/images/center-name-icon.png', auditEventId: 'ADM-064' },
  devices: { idKey: 'partnerID', auditEventId: 'ADM-065' },
